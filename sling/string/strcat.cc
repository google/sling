...
//    of a mix of raw C strings, Texts, strings, and integer values.
// ----------------------------------------------------------------------
...
string StrCatMulti(const AlphaNum *a, ...) {
  string result;
...
// It's possible to call StrAppend with a Text that is itself a fragment
