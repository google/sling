...
#ifndef SLING_STRING_ASCII_CTYPE_H_
#define SLING_STRING_ASCII_CTYPE_H_
...
static inline bool ascii_isalpha(unsigned char c) {
  return kAsciiPropertyBits[c] & 0x01;
}

static inline bool ascii_isalnum(unsigned char c) {
  return kAsciiPropertyBits[c] & 0x04;
}
...
#endif  // SLING_STRING_ASCII_CTYPE_H_
