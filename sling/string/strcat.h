...
#ifndef SLING_STRING_STRCAT_H_
#define SLING_STRING_STRCAT_H_
...
struct AlphaNum {
  ...
  AlphaNum(int32 i32)
      : text(digits, FastInt32ToBufferLeft(i32, digits) - &digits[0]) {}
  AlphaNum(uint32 u32)
  ...
  AlphaNum(double f)
    : text(digits, strlen(DoubleToBuffer(f, digits))) {}

  AlphaNum(const char *c_str) : text(c_str) {}
  AlphaNum(const Text &pc) : text(pc) {}
  AlphaNum(const string &s) : text(s) {}

  Text::size_type size() const { return text.size(); }
...
//    of a mix of raw C strings, Texts, strings, bool values,
//    and numeric values.
//
...
inline string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
                     ...
                     const AlphaNum &j) {
  const AlphaNum *end = nullptr;
  return StrCatMulti(&a, &b, &c, &d, &e, &f, &g, &h, &i, &j, end);
}
...
inline string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
  ...
  const AlphaNum *end = nullptr;
  return StrCatMulti(&a, &b, &c, &d, &e, &f, &g, &h, &i, &j, &k, end);
}
...
inline string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
  ...
  const AlphaNum *end = nullptr;
  return StrCatMulti(&a, &b, &c, &d, &e, &f, &g, &h, &i, &j, &k, &l, end);
}
...
inline string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
                     ...
                     const AlphaNum &m) {
  const AlphaNum *end = nullptr;
  return StrCatMulti(&a, &b, &c, &d, &e, &f, &g, &h, &i, &j, &k, &l, &m, end);
}
...
inline string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
  ...
  const AlphaNum *end = nullptr;
  return StrCatMulti(&a, &b, &c, &d, &e, &f, &g, &h, &i, &j, &k, &l, &m, &n,
                     end);
}
...
inline string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
  ...
  const AlphaNum *end = nullptr;
  return StrCatMulti(&a, &b, &c, &d, &e, &f, &g, &h, &i, &j, &k, &l, &m, &n, &o,
                     end);
}
