...
class File {
 ...
 public:
  ...
  // Reads up to "size" bytes to buffer from file. Returns the number of bytes
  // read or zero on end of file. Fails on read errors.
  size_t ReadOrDie(void *buffer, size_t size);
