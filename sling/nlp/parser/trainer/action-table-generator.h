...
#ifndef SLING_NLP_PARSER_TRAINER_ACTION_TABLE_GENERATOR_H_
#define SLING_NLP_PARSER_TRAINER_ACTION_TABLE_GENERATOR_H_
...
#endif  // SLING_NLP_PARSER_TRAINER_ACTION_TABLE_GENERATOR_H_
