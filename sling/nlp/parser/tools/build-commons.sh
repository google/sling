...
# Build binaries.
bazel build -c opt sling/nlp/parser/tools:build-store

# Convert PropBank to SLING format.
python sling/nlp/parser/tools/propbank-to-sling.py

# Build commons.
bazel-bin/sling/nlp/parser/tools/build-store -o /tmp/commons \
