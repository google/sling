...
#ifndef SYNTAXNET_DRAGNN_CORE_OPS_COMPUTE_SESSION_OP_H_
#define SYNTAXNET_DRAGNN_CORE_OPS_COMPUTE_SESSION_OP_H_
...
#endif  // SYNTAXNET_DRAGNN_CORE_OPS_COMPUTE_SESSION_OP_H_
